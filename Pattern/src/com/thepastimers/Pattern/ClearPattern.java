 ...
 */
public class ClearPattern extends BukkitRunnable {
    ...
    public ClearPattern(JavaPlugin plugin, Database d, Player p, String world, String pattern, int startx, int starty, int startz) {
        this.plugin = plugin;
        this.database = d;
        this.player = p;
    ...
    private ClearPattern(JavaPlugin plugin, Database d, Player p, String world, String pattern, int startx, int starty, int startz, int curx, int cury, int curz, int done) {
        this.plugin = plugin;
        this.database = d;
        this.player = p;
        this.pattern = pattern;
    ...
    public void run() {
        ...
        if (!areWeDone) {
            BukkitTask task = new ClearPattern(plugin,database,player,world,pattern,startx,starty,startz,curx,cury,curz,done).runTaskLater(plugin,delay);
        } else {
            if (player != null) {
