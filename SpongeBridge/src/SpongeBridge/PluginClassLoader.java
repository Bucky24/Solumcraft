...
public class PluginClassLoader extends URLClassLoader {
    private SpongeBridge loader;
    public JavaPlugin plugin;
    public File file;
    private final Map<String, Class<?>> classes = new HashMap<String, Class<?>>();
    private String name;

    public PluginClassLoader(SpongeBridge loader, File file, ClassLoader parent, PluginDescription description) throws Exception {
        ...
        Class<?> jarClass;
        try {
            loader.getLogger().info("PluginClassLoader.PluginClassLoader: Loading class " + description.mainClass);
        ...
        loader.getLogger().info("Loaded plugin " + description.name);
    ...
    public PluginClassLoader(SpongeBridge loader, File file, ClassLoader parent) throws Exception {
        super(new URL[] {file.toURI().toURL()},parent);
        this.file = file;
        this.loader = loader;
